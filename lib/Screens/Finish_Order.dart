...
class Finish_Order extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        children: [
              ...
              Positioned( top: 120,left: 50,right: 50,
                  child: Image(image: AssetImage('lib/Assets/Finish_Order.png'))),
              SafeArea(
           child:Padding(
    ...
    Icon(Icons.wifi,color: CupertinoColors.activeGreen,size: 15),
      ...
      Icon(CupertinoIcons.battery_100,color: CupertinoColors.activeGreen,size: 15),
              ...
              Text('Order Completed ',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30 )),
              SizedBox(height: 10),
              Text('Please rate your last Driver',style: TextStyle(fontWeight: FontWeight.normal,fontSize: 12,color: Colors.grey)),
              SizedBox(height: 10),
              Padding(
