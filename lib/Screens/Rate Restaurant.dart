...
class Rate_Restaurant extends StatelessWidget {
    ...
    return Scaffold(
      body: Column(
        children: [
          Stack(
            children: [
              ...
              Positioned( top: 120,left: 50,right: 50,
                  child: Image(image: AssetImage('lib/Assets/rate restaurant.png'))),
              SafeArea(
                child:Padding(
          ...
          SizedBox(height: 10),
          Text('Please rate your Restaurant',style: TextStyle(fontWeight: FontWeight.normal,fontSize: 12,color: Colors.grey)),
          SizedBox(height: 10),
          Padding(
