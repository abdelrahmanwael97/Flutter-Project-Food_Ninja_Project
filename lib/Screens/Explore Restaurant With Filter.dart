...
class Explore_Restaurant_With_Filter extends StatelessWidget {
              ...
              child: Row(
                children: [
                  Container( height: 40, width: 120, color: Colors.blueGrey,
                      ...
                      child:Center(child: Text('>10 Km     x', style: TextStyle(color: CupertinoColors.activeOrange,
                          fontSize: 18,fontWeight: FontWeight.bold)))),
                  SizedBox(width: 20),
                  Container( height: 40, width: 80, color: Colors.blueGrey,

                      child:Center(child: Text('Soup   x', style: TextStyle(color: CupertinoColors.activeOrange,
                          fontSize: 18,fontWeight: FontWeight.bold)))),
